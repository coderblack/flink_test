...
public class JdbcDynamicTableSource
    ...
    // TODO  自定义lookup额外过滤条件
    String lookupExtraFilter;
    ...
    public JdbcDynamicTableSource(
            ...
            String lookupExtraFilter  // TODO 额外添加的自定义过滤条件
    ) {
        ...
        this.lookupExtraFilter = lookupExtraFilter;
    }
    ...
    public LookupRuntimeProvider getLookupRuntimeProvider(LookupContext context) {
        ...
        JdbcRowDataLookupFunction lookupFunction =
                new JdbcRowDataLookupFunction(
                        ...
                        keyNames,
                        rowType,
                        lookupExtraFilter); // TODO 添加自定义过滤条件
        if (cache != null) {
    ...
    public DynamicTableSource copy() {
        JdbcDynamicTableSource newSource =
                new JdbcDynamicTableSource(
                        options, readOptions, lookupMaxRetryTimes, cache, physicalRowDataType,lookupExtraFilter);
