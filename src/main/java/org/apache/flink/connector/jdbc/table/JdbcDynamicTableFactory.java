...
public class JdbcDynamicTableFactory implements DynamicTableSourceFactory, DynamicTableSinkFactory {
    ...
    public DynamicTableSource createDynamicTableSource(Context context) {
        final FactoryUtil.TableFactoryHelper helper =
                FactoryUtil.createTableFactoryHelper(this, context);
        final ReadableConfig config = helper.getOptions();
        // TODO 从options中获取我们自定义的lookup额外过滤条件参数值
        String extraFilter = config.get(LOOKUP_EXTRA_FILTER);
        ...
        return new JdbcDynamicTableSource(
                ...
                context.getPhysicalRowDataType(),extraFilter);  // TODO 添加了构造参数
    }
    ...
    public Set<ConfigOption<?>> optionalOptions() {
        ...
        optionalOptions.add(LOOKUP_EXTRA_FILTER);  // 自定义参数
